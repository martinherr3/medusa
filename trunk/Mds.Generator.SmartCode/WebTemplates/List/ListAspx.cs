...
{
    public class ListAspx : EntityTemplate
    {
        public ListAspx()
        {
        ...
        public override void ProduceCode()
        {
            ...
            if (primaryKeyColumns.Count > 0)
            {
                ...
                WriteLine(@"<%@ Page Language=""C#"" AutoEventWireup=""true"" CodeBehind=""{0}List.aspx.cs"" Inherits=""{1}.Web.{0}List"" %>", Helper.ClassName(Entity.Code), Helper.PascalCase(Project.Code));
