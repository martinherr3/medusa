...
{
    public class EditCodeBehind : EntityTemplate
    {
        ...
        public override void ProduceCode()
        {
            ...
            if (primaryKeyColumns.Count > 0)
            {
                ...
                WriteLine(@"using {0}.Data;", Helper.PascalCase(Project.Code));
                WriteLine(@"using {0}.Core.Project;", Helper.PascalCase(Project.Code));
                WriteLine(@"");
                ...
                foreach (ColumnSchema column in Table.NoPrimaryKeyColumns())
                {
                    switch (column.NetDataType)
                    {
                        ...
                        case "System.Byte[]":
                            break;
                        default:
                            if (column.Control is Kontac.Net.SmartCode.Model.Profile.CheckBox)
                            {
