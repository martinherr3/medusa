...
{
    public class NHibernateClassWCF : EntityTemplate
    {
        public NHibernateClassWCF()
        {
            CreateOutputFile = true;
            Description = "Generates a C# class for use with NHibernate and attributes for WCF";
            Name = "Class File WCF enabled";
            OutputFolder = "NHibernate/EntityWCF";
        }
